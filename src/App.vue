    ...
    <main class="container mx-auto p-6 flex-1">
      <div v-if="choice === null" class="flex items-center justify-center -mx-6">
        ...
        <button @click="play('rock')"
          class="bg-white rounded-full shadow-lg w-64 p-12 mx-6 transition-colors duration-300 hover:bg-red-500">
      ...
      <div v-else>
        ...
        <button @click="ResetRound" class="bg-red-500 text-lg py-2 px-4">Reset</button>
      </div>
